...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--joboutput', default='${{HOME}}/job_output_%%A_%%a.out', help='the output log path you would like to give your job, this is optional')
    parser.add_argument('-e', '--joberror', default='${{HOME}}/job_output_%%A_%%a.err', help='the error log path you would like to give your job, this is optional')
