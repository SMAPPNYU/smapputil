...
def get_last_week(df, logger):
    ...
    s.sendmail('nhb228@nyu.edu', ['nhb228@nyu.edu', 'leon@leonyin.org', 'joshua.tucker@nyu.edu', 'jonathan.nagler@nyu.edu'], msg.as_string())
    s.quit()
