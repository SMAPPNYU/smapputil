...
import query_user_id_distribution
...
class TestQueryDistribution(unittest.TestCase):
    ...
    def test_merge_json_parse_args(self):
        args = query_user_id_distribution.parse_args(['-i', '~/data1.json', '-o', '~/data3.json'])
    ...
    def test_query_user_ids_distribution(self):
        ...
        with open(os.path.dirname(os.path.abspath(__file__))+'/../test/test_user_ids.json') as f:
